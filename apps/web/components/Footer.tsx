        ...
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><Link href="/home#features" className="text-slate-400 hover:text-blue-400 transition-colors">Features</Link></li>
              <li><Link href="/realtime" className="text-slate-400 hover:text-blue-400 transition-colors">Live Dashboard</Link></li>
              <li><Link href="/stocks" className="text-slate-400 hover:text-blue-400 transition-colors">History Analysis</Link></li>
